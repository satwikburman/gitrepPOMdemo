...
public class gridDemo {
	...
	public void search() throws MalformedURLException, InterruptedException {
		...
		WebDriver rwb=new RemoteWebDriver(new URL("http://localhost:4545/wd/hub"),dp);
	...
	public void goIbibo() throws InterruptedException {
        ...
        Thread.sleep(4000);
        WebElement dateofdep=driver.findElement(By.xpath("//div[@class='DayPicker-Caption']"));
        String actual=dateofdep.getText();
        System.out.println(actual);
        String predicted="June 2019";
        System.out.println("************");
        while(actual.contains("2019")) {
        	driver.findElement(By.xpath("//div[@class='DayPicker-NavBar']/span")).click();
        	WebElement innerdateofdep=driver.findElement(By.xpath("//div[@class='DayPicker-Caption']"));
        	String innerac=innerdateofdep.getText();
        	System.out.println(innerac);
        	if(innerac.equalsIgnoreCase(predicted)) {
        		driver.findElement(By.id("fare_20190606")).click();
        		System.out.println("Next operation is break");
        		break;
        ...
        driver.findElement(By.id("fare_20190625")).click();
        ...
        Thread.sleep(3000);
        driver.findElement(By.id("gosuggest_inputDest")).sendKeys("kol");
        Thread.sleep(3000);
